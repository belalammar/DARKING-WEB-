<html lang="en" dir="ltr"><head>
		...
		<!-- Title -->
		<title>Registeration - Buy Bank Login, CC, Chase Bank logs, CC Drop, Scampages, Email leads,Boa Bank Logs, Canada Logs, Uk logs, SMTP, Rdp, Cpanel, PHP Mailer</title>
								...
								<div class="col-xl-12 col-md-12 col-md-12">
									<div class="card">
										<div class="card-body">
											...
											<p class="text-muted">Signup to continue</p>
											...
											<div class="row">
												<div class="col-12">
													<button type="submit" name="signup" class="btn btn-primary btn-block">Login</button>
												</div>
												<div class="col-12">
													<a href="login.php" class="btn btn-link box-shadow-0 px-0 md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Login?</a>
												</div>
											</div>
											</form>
										</div>
