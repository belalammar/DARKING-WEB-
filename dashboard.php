						...
						<div class="d-flex">
							...
							<div class="d-flex order-lg-2 ml-auto header-rightmenu">
								...
								<div class="dropdown header-user">
									...
									<a href="logout.php" class="nav-link leading-none siderbar-link md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">
										<span class="mr-3 d-none d-lg-block ">
						...
						<nav class="horizontalMenu clearfix" style="height: 576px;"><div class="overlapblackbg"></div>
							<ul class="horizontalMenu-list">
								...
								<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="bank-logins" class="sub-icon md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">
								 <i class="fa fa-bank"></i>Bank Logs <i class="fa fa-angle-down horizontal-icon"></i></a>
											...
											<div class="mega-menubg">
												<div class="row">
													<div class="col-lg-3 col-md-12 col-xs-12 link-list">
														<ul>
															<li aria-haspopup="true"><a href="chase.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Chase Bank Logs</a></li>
															<li aria-haspopup="true"><a href="boa.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">BOA Logs</a></li>
															<li aria-haspopup="true"><a href="suntrust.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Suntrust Logs</a></li>
															<li aria-haspopup="true"><a href="td-usa.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">TD Bank USA</a></li>
															<li aria-haspopup="true"><a href="citi.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Citi Bank</a></li>
															<li aria-haspopup="true"><a href="hsbc-usa.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Hsbc - USA</a></li>
															<li aria-haspopup="true"><a href="wells-fargo.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Wells Fargo </a></li>
														</ul>
													</div>
													...
													<div class="col-lg-3 col-md-12 col-xs-12 link-list">
														...
														<h2> Canadian Banks </h2>
															<li aria-haspopup="true"><a href="rbc.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">RBC Logs</a></li>
															<li aria-haspopup="true"><a href="bmo.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">BMO Logs</a></li>
															<li aria-haspopup="true"><a href="td-canada.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">TD Canada</a></li>
													...
													<div class="col-lg-3 col-md-12 col-xs-12 link-list">
														<ul>
														<h2>Uk Banks </h2>
															<li aria-haspopup="true"><a href="lollyds.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Lollyds Bank</a></li>
															<li aria-haspopup="true"><a href="hsbc-uk.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Hsbc - UK</a></li>
															<li aria-haspopup="true"><a href="halifax.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Halifax Bank</a></li>
															<li aria-haspopup="true"><a href="barclays.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Barclays Bank</a></li>
                                   ...
                                   <li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon md-opjjpmhoiojifppkkcdabiobhakljdgm_doc"><i class="fa fa-cc"></i>Cards<i class="fa fa-angle-down horizontal-icon"></i></a>
									<ul class="sub-menu">
										<li aria-haspopup="true"><a href="visa.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Visa Card</a></li>
										<li aria-haspopup="true"><a href="mastercard.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">MasterCard</a></li>
										<li aria-haspopup="true"><a href="amex.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">American Express</a></li>
								...
								<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon md-opjjpmhoiojifppkkcdabiobhakljdgm_doc"><i class="typcn typcn-chart-pie-outline"></i>Accounts <i class="fa fa-angle-down horizontal-icon"></i></a>
									<ul class="sub-menu">
										<li aria-haspopup="true"><a href="fb-account.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Facebook Account</a></li>
										<li aria-haspopup="true"><a href="linkedin.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Linkedin Account</a></li>
										<li aria-haspopup="true"><a href="pof.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">POF</a></li>
										<li aria-haspopup="true"><a href="mathc.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Match</a></li>
										<li aria-haspopup="true"><a href="christain-mingle.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Christian Mingle</a></li>
										<li aria-haspopup="true"><a href="zooks.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Zooks</a></li>
										<li aria-haspopup="true"><a href="instagram.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Instagram Accounts</a></li>
								...
								<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon md-opjjpmhoiojifppkkcdabiobhakljdgm_doc"><i class="typcn typcn-briefcase"></i> Spamming</a>
									<ul class="sub-menu">
										<li aria-haspopup="true"><a href="smtp.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">SMTP</a></li>
										<li aria-haspopup="true"><a href="php-mailer.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">PHP Mailer</a></li>
										<li aria-haspopup="true"><a href="rdp.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">RDP</a></li>
								...
								<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon md-opjjpmhoiojifppkkcdabiobhakljdgm_doc"><i class="typcn typcn-briefcase"></i>Email Leads</a>
									<ul class="sub-menu">
										<li aria-haspopup="true"><a href="cfo.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">CFO / CEO Leads</a></li>
										<li aria-haspopup="true"><a href="banks-leads.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Banks - Leads</a></li>
										<li aria-haspopup="true"><a href="consumer-leads.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Consumer Leads</a></li>
										<li aria-haspopup="true"><a href="pro-leads.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Professional Leads</a></li>
								...
								<li aria-haspopup="true"><span class="horizontalMenu-click"><i class="horizontalMenu-arrow fa fa-angle-down"></i></span><a href="#" class="sub-icon md-opjjpmhoiojifppkkcdabiobhakljdgm_doc"><i class="typcn typcn-cog-outline"></i> Scam Pages <i class="fa fa-angle-down horizontal-icon"></i></a>
									<ul class="sub-menu">
										<li aria-haspopup="true"><a href="bank-pages.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Bank Scampages</a></li>
										<li aria-haspopup="true"><a href="email-pages.php" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Email Scampages</a></li>
					...
					<div class="container ">
						<div class="row">
							...
							<div class="col col-auto">
								<a class="btn btn-primary mt-4 mt-sm-0 md-opjjpmhoiojifppkkcdabiobhakljdgm_doc" href="add-fund.php"><i class="fa fa-usd"></i> Add - Fund</a>
								<a class="btn btn-success mt-4 mt-sm-0 md-opjjpmhoiojifppkkcdabiobhakljdgm_doc" href="submit-ticket.php"><i class="fe fe-plus mr-1 mt-1"></i>Subit Ticket</a>
							</div>
						</div>
					</div>
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								<li class="breadcrumb-item"><a href="#" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Home</a></li>
									...
									<div class="row">
										<div class="col-xl-6 col-lg-6 col-sm-6 pr-0 pl-0">
											<div class="card-body text-center">
												<h5 class="text-white">Admin Email:
									            </h5><h2 class="mb-2 mt-3 fs-2 text-white mainvalue">admin@credit-upertools.store</h2>
									             
									        </div>
										</div>
										<div class="col-xl-6 col-lg-6 col-sm-6 pr-0 pl-0">
											<div class="card-body text-center">
												<h5 class="text-white">ICQ</h5>
									            <h2 class="mb-2 mt-3 fs-2 text-white mainvalue">749416606</h2>
				 ...
				 <!-- row -->
						<div class="row ">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h4><b>Welcome to <strong>belal </strong>  </b></h4>
										<p>Please read carefully our terms and conditions , especially the store rules, please read below before funding your account</p>
									</div>
								</div>
							</div><!-- col end -->
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h4><b>Account Funding</b></h4>
										<p>Before you can purchase any of our tools, your acount must be funded.<br>
										<strong>1.First funding is ($ 100 usd Minimum )<br>2. Second time you can fund any amount from 10 usd.</strong>
										</p>
									</div>
								</div>
							</div><!-- col end -->
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										...
										<p>Please if you purchase any tools here, please try to verify it within 24 hours, if the tools seems to be dead or not working perfectly, please submit a ticket to replace 
										or to refund .</p>
									</div>
								</div>
							</div><!-- col end -->
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<h4><b>Store Rules.</b></h4>
										<p>in our store we forbid the attitudes mentioned below:</p>
										<ul>
											<li><i class="fa fa-angle-double-right"></i>Bad Language ( F words) </li>
											<li><i class="fa fa-angle-double-right"></i>Don't act smart with admins</li>
											<li><i class="fa fa-angle-double-right"></i> Dont submit fake tools for refund</li>
											<li><i class="fa fa-angle-double-right"></i> Dont Submit Request for after 24 hours of tools purchase</li>
