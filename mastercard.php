			...
			<div class="page-main">
				...
				<div class="container content-area">
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item"><a href="#" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Cards</a></li>
								<li class="breadcrumb-item active" aria-current="page">Master  Card</li>
							</ol><!-- End breadcrumb -->
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header table-danger border-0">
										<h3 class=" mb-0 card-title">Master Card</h3>
									</div>
									<div class="">
					...
					<tr> 
														 <td>Master Card</td>
														 <td>52143162********</td>
                                                         <td>First and last name, Bill Address,Zip Code Email, <br>Phone Number,  Csv,VBV Pass, CVV Pass,SSN </td> 
                   ...
                   <tr> 
														 <td>Master Card</td>
														 <td>52381491********</td>
                                                         <td>First and last name, Full info,Bill Address,Zip Code Email, <br>Phone Number,  Csv,VBV Pass, CVV Pass,SSN </td> 
