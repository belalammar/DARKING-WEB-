 ...
 <!-- app-content-->
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">Barclays Bank Login</li>
							</ol><!-- End breadcrumb -->
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header table-danger border-0">
										<h3 class=" mb-0 card-title">Barclays Bank Logs</h3>
									</div>
									<div class="">
  ...
  <!-- Table Start-->
					   <tr>
                            ...
                            <td>Barclays Bank Logs</td>
                            <td>Barclays Savings Account</td>
					   ...
					   <tr>
                            ...
                            <td>Barclays Bank Logs</td>
                            <td>Barclays Company Account</td>
                            <td>Onine Access,Email Access,,<br> Security Questions ,<br>And Answers SSN, Card Infomation,<br>,Address, Support Pin </td>
                            <td>£120,999</td>
							 <!-- Your Price-->
							 <td>£255 </td>
					   ...
					   <tr>
                            ...
                            <td>Barclays Bank Logs</td>
                            <td>Barclays Checking Account</td>
                            <td>Onine Access,Email Access,,<br> Security Questions ,<br>And Answers SSN, Card Infomation,<br>,Address, Support Pin </td>
                            <td>£30,999</td>
							 <!-- Your Price-->
							 <td>£90 </td>
