  ...
  <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
    ...
    <div class="card shadow-lg">
      ...
      <div class="card-body px-0">
        <p class="text-center"><strong>161dt5bQ1DLZ7taDgszxeA385RcAyVS26B</strong></p>
        <p class="text-muted text-center">Send payment to the wallet above.<br>
     ...
     <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
    <div class="card shadow-lg">
      <div class="card-header card-header-divider text-center pt-4"> <img src="https://upload.wikimedia.org/wikipedia/commons/f/ff/Perfect_Money.png" class="img-fluid" style="max-height: 42px;" width="205" alt=""><br>
      </div>
      <div class="card-body px-0">
        <p class="text-center"><strong>U19431219</strong></p>
        <p class="text-muted text-center">Send Payment to the wallet above.<br>
          Payment will be credited after 1 confirmation.<br>
        </p>
      </div>
