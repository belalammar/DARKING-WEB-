					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								<li class="breadcrumb-item"><a href="#" class="md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Support</a></li>
								...
								<div class="card">
									<div class="list-group list-group-transparent mb-0 mail-inbox">
										<div class="mt-4 mb-4 ml-4 mr-4 text-center">
											<a href="#" class="btn btn-primary btn-lg btn-block md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">Submit A Ticket</a>
										</div>
										<a href="" class="list-group-item list-group-item-action d-flex align-items-center active md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">
											<span class="icon mr-3"><i class="fe fe-inbox"></i></span>Admin Email: admin@drizzytools.store
										</a>
										
										<a href="" class="list-group-item list-group-item-action d-flex align-items-center active md-opjjpmhoiojifppkkcdabiobhakljdgm_doc">
											<span class="icon mr-3"><i class="fe fe-inbox"></i></span>Admin ICQ: 749416606
										</a>
									...
									<div class="inbox card-body">
										<form action="ticket.php" method="post">
											<div class="form-row mb-4">
												<label for="to" class="col-3 col-sm-2 col-md-3 col-lg-2 col-form-label">Your Email:</label>
												<div class="col-9 col-sm-10 col-md-9 col-lg-10">
													<input type="text" name="email" required="" class="form-control" id="to" placeholder="Type email">
												</div>
											</div>
											<div class="form-row mb-4">
												<label for="cc" class="col-3 col-sm-2 col-md-3 col-lg-2 col-form-label">Admin Department:</label>
												<div class="col-9 col-sm-10 col-md-9 col-lg-10">
													<select class="form-control" name="department">
													<option>Select Department   </option>
													<option value="funding"> Funding Department  </option>
													<option value="refund"> Refund Department  </option>
													<option value="replacement">Replace Department   </option>
											...
											<div class="form-row mb-4">
												...
												<div class="form-group mt-3 ">
													<textarea class="form-control" id="message" name="message" required="" rows="12" placeholder="Type your message"></textarea>
												</div>
												<div class="form-group mb-0">
													<button type="submit" class="btn btn-sm btn-success mt-1 mb-1">Send</button>
