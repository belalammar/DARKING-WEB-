				...
				<div class="container content-area">
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb"><!-- breadcrumb -->
								...
								<li class="breadcrumb-item active" aria-current="page">lloyds Login</li>
							</ol><!-- End breadcrumb -->
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header table-danger border-0">
										<h3 class=" mb-0 card-title">lloyds Logs</h3>
									</div>
									<div class="">
                    ...
                    <!-- Table Start-->
					   <tr>
                            ...
                            <td>lloyds Bank Logs</td>
                            <td>ABCIB Savings Account</td>
					   ...
					   <tr>
                            ...
                            <td>£100,999</td>
                             ...
                             <i class="fa fa-shopping-cart"></i> Purchase</a></div></td>
                            <td>
                              <button class="btn btn-outline-success" onclick="showSwal('warning-message-and-cancel')">Buy Now</button>
                            </td>
                        </tr>
						  <!--Tables End-->
						  <!-- Table Start-->
